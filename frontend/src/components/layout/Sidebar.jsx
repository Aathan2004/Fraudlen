...
import { LayoutDashboard, Users, Upload, Shield, ChevronRight, LogOut } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 shrink-0 h-screen sticky top-0 flex flex-col bg-bg-surface border-r border-bg-border">
      {/* Logo */}
